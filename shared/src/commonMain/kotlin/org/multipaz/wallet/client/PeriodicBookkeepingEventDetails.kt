...
/**
 * Details recorded when a periodic bookkeeping job runs.
 *
 ...
 * @property runtimeDurationMs the duration elapsed while performing the periodic bookkeeping job, in milliseconds.
 */
@CborSerializable
