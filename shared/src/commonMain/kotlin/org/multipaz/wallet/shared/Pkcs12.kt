...
class WrongPassphraseException(message: String, cause: Throwable? = null) : Exception(message, cause)
 ...
 * @throws IllegalArgumentException if the given contents does not appear to be from a PKCS#12 file or no private key was found.
 */
